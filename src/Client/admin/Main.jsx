        ...
        <>
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="w-16 h-16 flex-shrink-0 rounded-xl bg-gray-100">
                      <img
                        ...
                        src={event.picture || "/defaultAvater.jpg"}
                        alt={event.name}
                      />
                    </div>
          ...
          {profileView && (
            <AnimatePresence exitBeforeEnter>
              ...
              >
                <div className="flex-1 flex pt-12 justify-center h-180">
                  <div className="w-[80%] rounded-2xl shadow-2xl">
                    {(businesses?.length > 0 ? businesses : [{}]).map(
                      (business, index) => (
                        <div className="space-y-12" key={index}>
                          ...
                          <div
                            style={{
                              backgroundImage: `url(${
                                business.cover || "/defaultAvater.jpg"
                              })`,
                            }}
                          ...
                          >
                            <div className="absolute top-24 left-12 w-22 h-22 bg-center bg-cover overflow-hidden outline outline-2 outline-white rounded-full">
                              <img
                                src={business.logo || "/defaultAvater.jpg"}
                                alt="photo preview"
                                className="w-full h-full object-cover"
                              />
                            </div>
                          ...
                          <div className="pl-4 space-y-6 text-sm">
                            {business.info?.length > 0
                              ? business.info.map((info, idx) => (
                              ...
                              : ["phone", "instagram", "address", "email"].map(
                                  (type, idx) => (
                                    <div className="flex" key={idx}>
                                      <div className="w-12 flex text-[#FF7800] justify-center items-center">
                                        {type === "phone" && (
