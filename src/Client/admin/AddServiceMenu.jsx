  ...
  return (
    <div className=" h-[36px] w-40   justify-center items-center text-white rounded-md space-y-1">
      ...
      <button
        ...
        className="flex pl-2 pt-1 justify-between w-full h-full  cursor-pointer hover:bg-[#545151] duration-300"
      >
        Upload URL
        <FontAwesomeIcon
          className="text-md pr-3 flex  justify-center items-center"
          icon={faLink}
        />
      </button>
    </div>
    ...
    <div className="">
      <div className="flex pt-3 w-90 h-40 bg-[#343434] flex-col text-white rounded-md space-y-2">
        ...
        <div className="flex items-center justify-between w-full px-4">
          ...
          <button className="text-[#168FF4] font-bold w-14 h-8 cursor-pointer">
            Add
          </button>
        </div>
        <div className="flex justify-center items-center ">
          <button className=" w-50 h-10 bg-[#484646] text-white rounded-md cursor-pointer">
      ...
      <div className="flex pt-3 w-86 h-64 bg-[#343434] flex-col text-white rounded-md space-y-2">
        ...
        <div className="pt-3">
          <div className="flex  w-70  ml-6  h-10  border-inherit bg-[#484646] items-center ">
            <button
              onClick={() => handleActicve("fixed")}
              className={`w-18 h-full border-r border-black text-white  cursor-pointer
            ${active == "fixed" && "bg-[#168FF4]"}`}
            >
              Fixed
            </button>
            <button
              onClick={() => handleActicve("from")}
              className={`w-18 h-full border-r border-black text-white  cursor-pointer
            ${active == "from" && "bg-[#168FF4]"}`}
            >
              From
            </button>
            <button
              onClick={() => handleActicve("free")}
              className={`w-18 h-full border-r border-black text-white  cursor-pointer
            ${active == "free" && "bg-[#168FF4]"}`}
            >
              Free
            </button>
            <button
              onClick={() => handleActicve("hidden")}
              className={`w-18 h-full border-r border-black text-white  cursor-pointer
            ${active == "hidden" && "bg-[#168FF4]"}`}
            >
              Hidden
            </button>
          </div>
            ...
            <>
              <div className="flex h-16 w-full justify-between mr-4 border-b border-black">
                ...
                <input
                  ...
                  className="text-[#168FF4] font-bold ] w-24 px-8 outline-none "
                />
              </div>
              ...
              <div className=" relative flex h-full w-full justify-between mr-4">
                ...
                <button
                  ...
                  className="text-[#168FF4] font-bold ] mr-3 cursor-pointer"
                >
                  USD
                  <FontAwesomeIcon
...
export { EllipisMenu, Duration, Price, URL, Photo };
