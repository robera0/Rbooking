      ...
      <div className="  space-y-8 ">
        ...
        <div className="pl-4  space-y-4  w-[90%] ">
          <div className="  flex h-12 bg-[#343434] hover:bg-[#323232] cursor-pointer rounded-sm">
            <Toggle name="Booking Confirmation to Client" />
          </div>
          <p className="text-[#8C8484]">
            Sends a confirmation email to clients with appointment details upon
            booking.
          </p>
        </div>
        <div className="pl-4  space-y-4  w-[90%] ">
          <div className="  flex h-12 bg-[#343434] hover:bg-[#323232] cursor-pointer rounded-sm">
            <Toggle name="Owner Booking to Notification" />
          </div>
          <p className="text-[#8C8484]">
            Notifies the business owner via email when a new appointment is
            booked.
          </p>
        </div>
