...
const Wishlist = () => {
  ...
  if (wishlistLoading) {
    return (
      <div className="pl-6">
        <div className="border border-gray-600/40 w-[97%] pl-4 pt-6 rounded-md">
  ...
  return (
    <div className="pl-6">
      ...
      <div className="border border-gray-600/40 w-[97%] pl-4 pt-6 rounded-md space-y-4">
        {/* HEADER */}
        ...
        <Listbox value={selected} onChange={setSelected}>
          <div className="relative w-1/2">
            ...
            <Listbox.Options className="absolute z-10 mt-1 w-full rounded-md bg-[#222529] border border-gray-600/40 shadow-lg">
              {options.map((option) => (
                <Listbox.Option
                  key={option.id}
                  value={option}
                  className={({ active }) =>
                    `cursor-pointer px-3 h-10 flex items-center text-sm ${
        ...
        {sortedEvents.length === 0 ? (
          ...
          <div className="mb-12 pr-4">
            <AnimatePresence mode="popLayout">
              {sortedEvents.map((w) => {
                const isMutating =
                  wishlistMutation.variables?.event_id === w._id;
                ...
                return (
                  <motion.div
                    ...
                    className="w-full rounded-2xl bg-[#191B1D] p-4 flex items-stretch gap-4 hover:bg-[#1e2023] transition-colors mb-6"
                  >
                    {/* IMAGE */}
                    <img
                    ...
                    <div className="flex-1 flex flex-col justify-between min-w-0">
                      ...
                      <div className="mt-3 flex items-center justify-between gap-3">
                        ...
                        >
                          <button className="w-full bg-orange-500 hover:bg-orange-600 text-white text-xs px-4 py-2 rounded-md">
                            View
                          </button>
                        </Link>
                      </div>
